    ...
    <div class="center"> 
     ...
     <div class="m-progress"> 
      <div class="m-progress-list"> 
       <span class="step-1 step" id="span1"> <em class="u-progress-stage-bg"></em> <i class="u-stage-icon-inner">1<em class="bg"></em></i> <p class="stage-name">保密问题验证</p> </span> 
     ...
     <form class="am-form am-form-horizontal" action="/doforget" method="post"> 
      <div class="center div1" style="display:;"> 
       ...
       {{csrf_field()}}
       <input type="submit" value="点击获取保密问题验证" class="am-btn am-btn-success" id="huoqu" style="display:block;float:left;width:150px">
      </div> 
