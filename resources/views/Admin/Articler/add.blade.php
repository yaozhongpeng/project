 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/adminarticleredis" method="post" enctype="multipart/form-data"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">标题</label> 
       <div class="mws-form-item"> 
        <input type="text" class="small" name="title" placeholder="公告标题" /> 
       </div> 
      </div>
      <div class="mws-form-row"> 
       <label class="mws-form-label">作者</label> 
       <div class="mws-form-item"> 
        <input type="text" class="small" name="editor" placeholder="公告作者" /> 
       </div> 
      </div>
      <div class="mws-form-row"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
       <script id="editor" type="text/plain" name="descr" style="width:800px;height:350px;"></script>
       </div> 
      </div>
