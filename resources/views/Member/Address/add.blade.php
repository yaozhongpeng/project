...
<div class="panel-body">
    <div class=" form">
        <form class="cmxform form-horizontal adminex-form" id="commentForm" method="post" action="/myaddress" novalidate="novalidate">
            <div class="form-group ">
                <label for="curl" class="control-label col-lg-1">姓名</label>
                <div class="col-lg-10">
                    <input class="form-control" id="curl" type="text" name="name">
                </div>
            </div>
            <div class="form-group ">
            ...
            <div class="form-group ">
                ...
                <div class="col-lg-10">
                    <textarea class="form-control " id="ccomment" name="zhi" required=""></textarea>
                </div>
            </div>
            <div class="form-group">
